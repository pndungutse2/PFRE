...
The goal is to help users make a better day - to -day financial decisions including, what to save, where to cut back, and when to invest. 
...
3. Financial Health Score: Compute composite score based on savings rate, expense stability, debt ratio, and emergency funcd coverage
